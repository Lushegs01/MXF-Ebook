...
const EXERCISE_LIST: Exercise[] = [
  ...
  },
  {
    ...
    instructions: [
      ...
      'Brace your core and press both dumbbells overhead until your arms are straight.',
      'Lower them back to shoulder height under control and repeat.',
    ],
    commonMistake: 'Arching the lower back to drive the weight up. Keep your core braced and ribs down.',
  },
  {
    id: 'lateral-raise',
    name: 'Lateral Raise',
    ...
    instructions: [
      ...
      'With a slight bend in the elbows, raise the weights out to the sides until level with your shoulders.',
      'Pause briefly at the top, then lower under control.',
    ],
    commonMistake: 'Swinging the weights up with momentum. Use a lighter load and lead with the elbows.',
  },
  {
    id: 'knee-push-up',
    name: 'Knee Push-Up',
    ...
    instructions: [
      ...
      'Keep a straight line from knees to head and lower your chest toward the floor.',
      'Press back up until your arms are fully extended.',
    ],
    commonMistake: 'Letting the hips sag or pike up. Keep your core tight and your body in a straight line.',
  },
  {
    id: 'chair-dips',
    name: 'Chair Dips',
    ...
    image: IMG.chest,
    instructions: [
      'Sit on the edge of a sturdy chair and grip the front edge beside your hips.',
      'Slide your hips off the seat and lower your body by bending your elbows to about 90°.',
      'Press through your palms to straighten your arms and lift back up.',
    ],
    commonMistake: 'Shrugging the shoulders up toward the ears. Keep your chest up and shoulders down.',
  },
  {
    id: 'glute-bridge',
    name: 'Glute Bridge',
    ...
    commonMistake: 'Overarching the lower back at the top. Squeeze the glutes and keep your ribs down.',
  },
  {
    id: 'hammer-curl',
    name: 'Hammer Curls',
    ...
    instructions: [
      ...
      'Keeping your elbows pinned to your sides, curl the weights up.',
      'Squeeze at the top, then lower slowly to the start.',
    ],
    commonMistake: 'Rotating the wrists during the curl. Keep a neutral, thumbs-up grip throughout.',
  },
  {
    id: 'reverse-curl',
    name: 'Reverse Curls',
    ...
    image: IMG.muscle,
    instructions: [
      'Hold a dumbbell or bar with an overhand grip, palms facing down.',
      'Keeping your elbows tucked at your sides, curl the weight up toward your shoulders.',
      'Pause at the top, then lower under control.',
    ],
    commonMistake: 'Using too much weight and swinging. Lower the load and keep your wrists firm.',
  },
  {
    id: 'swim-press-up',
    name: 'Swim Press-Up',
    ...
    image: IMG.chest,
    instructions: [
      'Start in a push-up position with hands slightly wider than your shoulders.',
      'Lower your chest toward the floor, then glide your body forward and up in a smooth swimming motion.',
      'Reverse the motion back to the start, keeping your core braced throughout.',
    ],
    commonMistake: 'Letting the hips sag as you glide. Keep your core engaged to protect the lower back.',
  },
  {
    id: 'goblet-squat',
    name: 'Goblet Squats',
    ...
    instructions: [
      ...
      'Sit your hips down and back until your thighs are parallel, then drive up through your heels.',
    ],
    commonMistake: 'Letting the chest collapse forward. Keep the weight tight to your chest and torso upright.',
  },
  {
    id: 'sumo-squat',
    name: 'Sumo Squats',
    ...
    image: IMG.legs,
    instructions: [
      'Stand with a wide stance, toes pointed out at about 45°.',
      'Keeping your chest up, lower your hips straight down until your thighs are parallel.',
      'Drive through your heels and squeeze your glutes to stand back up.',
    ],
    commonMistake: 'Letting the knees cave inward. Push them out in line with your toes.',
  },
  {
    id: 'russian-twist',
    name: 'Russian Twist',
    ...
    instructions: [
      ...
      'Hold your hands together or a weight in front of your chest, lifting your feet if you can.',
      'Rotate your torso to tap the floor on one side, then twist to the other.',
    ],
    commonMistake: 'Rounding the back and moving only the arms. Keep your chest up and rotate from the torso.',
  },
  {
    id: 'v-up',
    name: 'V-Ups',
    ...
    instructions: [
      ...
      'Simultaneously lift your legs and torso, reaching your hands toward your toes to form a V.',
      'Lower back down under control without letting your feet touch the floor.',
    ],
    commonMistake: 'Jerking up with momentum. Move under control and keep your legs straight.',
  },
  {
    id: 'heel-taps',
    name: 'Heel Taps',
    ...
    image: IMG.fatLoss,
    instructions: [
      'Lie on your back with knees bent and feet flat, heels close to your glutes.',
      'Crunch up slightly and reach your right hand to tap your right heel.',
      'Return to centre and repeat on the left side, alternating each rep.',
    ],
    commonMistake: 'Pulling on the neck. Keep your gaze up and drive the movement from the obliques.',
  },
  {
    id: 'sit-up-press',
    name: 'Sit-Up to Press',
    ...
    image: IMG.fatLoss,
    instructions: [
      'Lie on your back with knees bent, holding a dumbbell at your chest.',
      'Sit all the way up, then press the weight straight overhead at the top.',
      'Bring the weight back to your chest and lower under control to the floor.',
    ],
    commonMistake: 'Using momentum to fling the weight up. Control the sit-up and the press separately.',
  },
  {
    id: 'dumbbell-crunch',
    ...
    instructions: [
      ...
      'Curl your shoulders off the floor, crunching toward your knees.',
      'Pause and squeeze your abs, then lower under control.',
    ],
    commonMistake: 'Pulling with the neck or hips. Keep the movement driven by your abs through a short range.',
  },
  {
    id: 'side-crunch',
    name: 'Side Crunch',
    ...
    image: IMG.fatLoss,
    instructions: [
      'Lie on your side with your legs stacked and your top hand behind your head.',
      'Crunch your top elbow toward your hip, lifting your shoulder off the floor.',
      'Lower under control and complete all reps before switching sides.',
    ],
    commonMistake: 'Pulling on the head and neck. Lead with the obliques and keep your neck relaxed.',
  },
];
...
const WORKOUT_LIST: Workout[] = [
  ...
  {
    id: 'shoulders-arms-sculpt',
    title: 'Shoulders & Arms Sculpt',
    categoryId: 'muscle-gain',
    duration: 35,
    intensity: 'Beginner',
    image: IMG.muscle,
    exerciseIds: ['shoulder-press', 'lateral-raise', 'hammer-curl', 'reverse-curl', 'chair-dips'],
  },
  {
    id: 'glutes-legs-burn',
    title: 'Glutes & Legs Burn',
    categoryId: 'strength',
    duration: 40,
    intensity: 'Beginner',
    image: IMG.legs,
    exerciseIds: ['goblet-squat', 'sumo-squat', 'glute-bridge', 'walking-lunge', 'romanian-deadlift'],
  },
  {
    id: 'core-abs-shred',
    ...
    intensity: 'Intermediate',
    image: IMG.fatLoss,
    exerciseIds: ['russian-twist', 'v-up', 'heel-taps', 'sit-up-press', 'dumbbell-crunch', 'side-crunch'],
  },
  {
    id: 'bodyweight-home-burn',
    title: 'Bodyweight Home Burn',
    categoryId: 'fat-loss',
    duration: 30,
    intensity: 'Beginner',
    image: IMG.cardio,
    exerciseIds: ['knee-push-up', 'swim-press-up', 'chair-dips', 'glute-bridge', 'mountain-climber'],
  },
];
